...
public class Union04Tests
{
    [Test]
    public void FromT1_SetsIndex1()
    {
        var union = Union<U1,U2,U3,U4>.FromT1(new U1(1));
    ...
    {
        var union = Union<U1,U2,U3,U4>.FromT2(new U2(2));
    ...
    {
        var union = Union<U1,U2,U3,U4>.FromT3(new U3(3));
    ...
    {
        var union = Union<U1,U2,U3,U4>.FromT4(new U4(4));
    ...
    {
        Should.Throw<ArgumentNullException>(() => Union<U1,U2,U3,U4>.FromT1(null!));
    }
    [Test]
    public void FromT2_Throws_WhenValueIsNull()
    {
        Should.Throw<ArgumentNullException>(() => Union<U1,U2,U3,U4>.FromT2(null!));
    }
    [Test]
    public void FromT3_Throws_WhenValueIsNull()
    {
        Should.Throw<ArgumentNullException>(() => Union<U1,U2,U3,U4>.FromT3(null!));
    }
    [Test]
    public void FromT4_Throws_WhenValueIsNull()
    {
        Should.Throw<ArgumentNullException>(() => Union<U1,U2,U3,U4>.FromT4(null!));
    }
    ...
    public void AsT1_ReturnsValue_WhenCorrectVariant()
    {
        ...
        var union = Union<U1,U2,U3,U4>.FromT1(expected);
    ...
    public void AsT1_Throws_WhenWrongVariant()
    {
        ...
        var union = Union<U1,U2,U3,U4>.FromT2(expected);
    ...
    public void AsT3_ReturnsValue_WhenCorrectVariant()
    {
        ...
        var union = Union<U1,U2,U3,U4>.FromT3(expected);
    ...
    public void AsT4_ReturnsValue_WhenCorrectVariant()
    {
        ...
        var union = Union<U1,U2,U3,U4>.FromT4(expected);
    ...
    {
        var union = default(Union<U1,U2,U3,U4>);
    ...
    {
        var a = Union<U1,U2,U3,U4>.FromT1(new U1(1));
        var b = Union<U1,U2,U3,U4>.FromT1(new U1(1));
    ...
    {
        var a = Union<U1,U2,U3,U4>.FromT1(new U1(1));
        var b = Union<U1,U2,U3,U4>.FromT2(new U2(1));
    ...
    {
        var a = Union<U1,U2,U3,U4>.FromT1(new U1(1));    
        var b = Union<U1,U2,U3,U4>.FromT1(new U1(2));
    ...
    {
        var union = Union<U1,U2,U3,U4>.FromT1(new U1(1));
        var type = typeof(Union<U1,U2,U3,U4>);
