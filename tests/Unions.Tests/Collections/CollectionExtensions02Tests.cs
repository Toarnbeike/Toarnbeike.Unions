...
public class Collection02Tests
{
    [Test]
    ...
    private static IEnumerable<Union<U1,U2>> CreateMixedCollection()
    {
    ...
    private static IEnumerable<Union<U1,U2>> CreateU1Collection()
    {
        yield return Union<U1,U2>.FromT1(new U1(1));
        yield return Union<U1,U2>.FromT1(new U1(2));
    ...
    private static IEnumerable<Union<U1,U2>> CreateU2Collection()
    {
