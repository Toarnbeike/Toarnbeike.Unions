...
/// </summary>
internal static class CollectionExtensionsTestsGenerator
{
    ...
    public static string Generate(int arity)
    {
        ...
        return $$"""
            {{AutoGeneratedMessageGenerator.GetAutoGeneratedMessage(nameof(CollectionExtensionsTestsGenerator))}}

            using Toarnbeike.Unions.Generic;
            using Toarnbeike.Unions.Generic.Collections;
            using Toarnbeike.Unions.Tests.TestTypes;

            namespace Toarnbeike.Unions.Tests.Collections.Generated;
