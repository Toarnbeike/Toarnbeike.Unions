...
internal static class UnionTestTypeGenerator
{
    ...
    {
        return $"""
            {AutoGeneratedMessageWriter.GetAutoGeneratedMessage(typeof(UnionTestTypeGenerator).FullName!)}
            ...
            {Enumerable.Range(1, maxArity).Select(GenerateTestType).JoinLines()}
